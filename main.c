...
// Isso é necessário porque quando o driver retorna todos os handles são fechados
// portanto, nosso handle da seção será fechado.
// criá-lo em uma thread do sistema evita isso
